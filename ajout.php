...
<form  action="" method="POST">
   <div class="loginbox">
    ...
    <?php
      re insert into accueil_mem(nom,mot_de_passe)
    $reponse = $bdd->query('insert into accueil_mem(nom,mot_de_passe)VALUES($_POST['nom'],$_POST['pass'])');
  while($données = $reponse -> fetch()){
     
     echo " Ajout reussi vous venez d'ajouter M.".$données['nom']; 
